...
# This python file is used to apply the found found model to the test portion of the data previously spared
"""
import CsvReader
import numpy as np
...
# Take the last 1/5th of the data for test, this part is not used for model estimation
rawTest = data[cutPoint:, :]
testY = Y[cutPoint:, :]

# normalization of the test part should be done independent of the survival data (to fill null values)
# for it to be an unbiased estimate because the future samples will be without survival data
normTest = CsvReader.Normalize(rawTest, [], numericColumns, catgColumns, 'test')
